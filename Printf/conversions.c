...
/*   Updated: 2022/02/17 14:57:02 by dpadrini         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf"

int	print_sc(char *str, int i, va_list args, t_flag *flag, int io)
{
	int	len;
	...
	if (arg == NULL)
		len == 6;
	if (io == 1 && flag->poin && flag->prec < len)
		len = flag->prec	
...
int	print_xX(char *str, int i, va_list args, t_flag *flags)
{
	long long int	num;
	int				n;
