...
{
	std::cout << this->_name << " health set to " << health << std::endl;
	std::cout << this->_name << " energy set to " << energy << std::endl;
	std::cout << this->_name << " attack set to " << attack << std::endl;
	this->_health = health;
	this->_energy = energy;
	this->_attack = attack;
}
...
void	ClapTrap::attack(const std::string& target)
{
	if (this->_energy < 1)
		return ;
	this->_energy--;
	std::cout << "ClapTrap " << this->_name << " attacks " << target << ", " << target << " takes ";
